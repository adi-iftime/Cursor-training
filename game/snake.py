"""Snake entity: segments and direction (Game Engine Agent domain)."""
...
class Snake:
    """Snake with head-first body list; coordinates are (row, col)."""
    ...
    def advance(self, new_direction: Direction, *, eat: bool) -> None:
        """Move head one cell; if eat is True, do not remove tail (length increases)."""
