# DAG owner: data_engineer — game rules (O(1) tick; cost_optimizer: tight loop).
"""Pure game engine: grid, food, collisions, score. No terminal I/O."""
...
class GameEngine:
    ...
    def __post_init__(self) -> None:
        ...
        body: list[PointT] = [(mid_r, mid_c), (mid_r, mid_c - 1), (mid_r, mid_c - 2)]
        self.snake = Snake(list(body), Direction.RIGHT)
